...
## Current Setup 
_Last Updated: 14-Feb-2022 or more recently._
- **[Neovim](https://neovim.io/)** - _Important Note_: these Dotfiles target bleeding edge Neovim APIs. I try to update these runtime files as soon as the Neovim team pushes changes (including & especially breaking) to [their master branch](https://git.io/NeovimHEAD) and I pull the latest. 
  ...
  - The Neovim [commit](https://github.com/neovim/neovim/commit/046950f6309070d98ab5a3deeff9d00e079ccdd4) that I am on: `NVIM v0.7.0-dev+1082-g046950f63`
...
- **[Rust](https://www.rust-lang.org/)** 🦀⚙
	- [compiler](https://rustup.rs/): `rust-analyzer 0247e5067 2022-02-14 dev`
  - [rust-analyzer](https://rust-analyzer.github.io/manual.html#nvim-lsp): `rust-analyzer 0247e5067 2022-02-14 dev` 
