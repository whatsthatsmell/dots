...
## Current Setup 
_Last Updated: 18-Feb-2022 or more recently._
- **[Neovim](https://neovim.io/)** - _Important Note_: these Dotfiles target bleeding edge Neovim APIs. I try to update these runtime files as soon as the Neovim team pushes changes (including & especially breaking) to [their master branch](https://git.io/NeovimHEAD) and I pull the latest. 
  ...
  - The Neovim [commit](https://github.com/neovim/neovim/commit/f4e24f1eabfac439ac09d9646582f682c02cfe3f) that I am on: `NVIM v0.7.0-dev+1102-gf4e24f1ea`
...
- **[Rust](https://www.rust-lang.org/)** 🦀⚙
	- [compiler](https://rustup.rs/) version: `rustc 1.60.0-nightly (75d9a0ae2 2022-02-16)`
  - [rust-analyzer](https://rust-analyzer.github.io/manual.html#nvim-lsp) version: `rust-analyzer 89faff747 2022-02-17 dev` 
