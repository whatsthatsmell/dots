...
## Current Setup 
_Last Updated: 30-Mar-2022 or more recently._

- **[Rust](https://www.rust-lang.org/)** 🦀⚙
	- [compiler](https://rustup.rs/) version: `rustc 1.61.0-nightly (9c06e1ba4 2022-03-29)`
	- [rust-analyzer](https://rust-analyzer.github.io/manual.html#nvim-lsp) version: `rust-analyzer 63c4d6b20 2022-03-30 dev`
- **[Neovim](https://neovim.io/)** - _Important Note_: these Dotfiles target bleeding edge Neovim APIs. I try to update these runtime files as soon as the Neovim team pushes changes (including & especially breaking) to [their master branch](https://git.io/NeovimHEAD) and I pull the latest. 
  ...
  - The Neovim [commit](https://github.com/neovim/neovim/commit/75ff156d9b11f23f6156cd6b90fb7bad0a83fd18) that I am on: `NVIM v0.7.0-dev+1356-g75ff156d9`
