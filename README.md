...
## Current Setup 
_Last Updated: 24-Jan-2022 or more recently._
- [Neovim](https://neovim.io/) - _Important Note_: these Dotfiles target bleeding edge Neovim APIs. I try to update these runtime files as soon as the Neovim team pushes changes (including & especially breaking) to [their master branch](https://git.io/NeovimHEAD) and I pull the latest. 
  ...
  - The Neovim [commit](https://github.com/neovim/neovim/commit/1907a9481423ccf4433f8184bbfdc633589e43f5) that I am on: `NVIM v0.7.0-dev+921-g1907a9481`
...
- [Rust](https://www.rust-lang.org/)
	- [compiler](https://rustup.rs/): `rustc 1.60.0-nightly (5e57faa78 2022-01-19)`
  - [rust-analyzer](https://rust-analyzer.github.io/manual.html#nvim-lsp): `rust-analyzer df5340386 2022-01-20 dev` 
